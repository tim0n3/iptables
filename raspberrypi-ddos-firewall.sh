...
$iptables -A INPUT -m comment --comment "Allowed Ports and Services for New conns" -j IN_CUSTOMRULES
...
$iptables -A IN_DPI_RULES -p ICMP --icmp-type 3 -m comment --comment "ICMP unreachable" -j ACCEPT
